...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if !PracticeSessionManager.shared.isSupported() {
    ...
    private func setupMainNavigation() {
        ...
        let landingViewController = MetricsViewController()
        mainNavigationController.setViewControllers([landingViewController], animated: true)
    }
}
